...
export default function Dashboard() {
    ...
    return (
        <>
            ...
            <section className="layout-container dash-page">
                <section className="main">
                    <section className="main-content" id="overview">
                        ...
                        <section className="analytics-graphs" id="analytics">
                            {/* MOOD ANALYTICS CARD */}
                            <section
                                className="cardz c-grey c-shadow analytics-mood"
                        ...
                        <section className="user-grid">
                            ...
                            >
                                ...
                                {/*QUESTFIX*/}
                                <section className="grid2" id="quest-recs">
                            ...
                            {/* JOURNAL CARD */}
                            <section
                                className="cardz analytics-journal c-grey c-shadow "
